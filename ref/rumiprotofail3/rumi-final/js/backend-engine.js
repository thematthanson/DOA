...
window.RumiBackend = {
    ...
    async loadContentLibrary(csvUrl = 'data/content-library-expanded.csv') {
        const maxRetries = 3;
        let lastError;
        ...
        console.error('🔧 Check that data/content-library-expanded.csv exists and is accessible via HTTP');
